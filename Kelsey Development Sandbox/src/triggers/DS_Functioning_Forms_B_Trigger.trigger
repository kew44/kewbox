/****
*@description trigger for Functioning_Forms_B object
*
*@modified    11/30/16    KW    remove unhandled 'after delete' clause, causing error in cleaning duplicate records 
****/
trigger DS_Functioning_Forms_B_Trigger on DS_Functioning_Forms_B__c  (before insert, before update, after insert, after update) {
